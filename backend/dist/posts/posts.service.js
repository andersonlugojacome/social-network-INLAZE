...
let PostsService = class PostsService {
    ...
    getPostss() {
        return __awaiter(this, void 0, void 0, function* () {
            const posts = yield this.PostsModel.find();
            return posts;
        });
    }
    getPosts(postsID) {
        return __awaiter(this, void 0, void 0, function* () {
            const Posts = yield this.PostsModel.findById(postsID);
            return Posts;
        });
    }
    createPosts(createPostsDTO) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updatePosts(postsID, createPostsDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            const updatedPosts = yield this.PostsModel
